      ...
      <div className="relative">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:hidden gap-4 sm:gap-6">
          {offerings.map((offering) => (
              <div key={offering.id} className="flex flex-col items-center py-4 sm:py-5 px-3 sm:px-4 gap-2 sm:gap-3 bg-white rounded-2xl sm:rounded-full shadow-lg shadow-[#097362]/40">
